...
in some version release Hydra you may should login and you can enter user <b>nethydra</b> and password <b>nethydra</b>. for sonar default cred `user: sonar` `password: nethydra`
